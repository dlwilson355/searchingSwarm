...
class ROBOT:
	...
	def send_objects(self, sim):
		self.O0 = sim.send_box(x=0, y=0, z=c.L + c.R, length=c.L, width=c.L, height=2*c.R, r=.5, g=.5, b=.5)
		...
		self.O5 = sim.send_cylinder(x=0, y=c.L*3/2, z=c.L/2+c.R, length=c.L, radius=c.R, r=1, g=0, b=0, r1=0, r2=0, r3=1)
		self.O6 = sim.send_cylinder(x=c.L*3/2, y=0, z=c.L/2+c.R, length=c.L, radius=c.R, r=0, g=1, b=0, r1=0, r2=0, r3=1)
		self.O7 = sim.send_cylinder(x=0, y=-c.L*3/2, z=c.L/2+c.R, length=c.L, radius=c.R, r=0, g=0, b=1, r1=0, r2=0, r3=1)
		self.O8 = sim.send_cylinder(x=-c.L*3/2, y=0, z=c.L/2+c.R, length=c.L, radius=c.R, r=1, g=0, b=1, r1=0, r2=0, r3=1)
	...
	def send_joints(self, sim):
		self.J0 = sim.send_hinge_joint(x=0, y=c.L/2, z=c.L+c.R, n1=-1, n2=0, n3=0, lo=-3.14159/2, hi=3.14159/2, first_body_id = self.O0, second_body_id = self.O1)
		self.J1 = sim.send_hinge_joint(x=0, y=c.L*3/2, z=c.L+c.R, n1=-1, n2=0, n3=0, lo=-3.14159/2, hi=3.14159/2, first_body_id = self.O1, second_body_id = self.O5)
		self.J2 = sim.send_hinge_joint(x=c.L/2, y=0, z=c.L+c.R, n1=0, n2=1, n3=0, lo=-3.14159/2, hi=3.14159/2, first_body_id = self.O0, second_body_id = self.O2)
		self.J3 = sim.send_hinge_joint(x=c.L*3/2, y=0, z=c.L+c.R, n1=0, n2=1, n3=0, lo=-3.14159/2, hi=3.14159/2, first_body_id = self.O2, second_body_id = self.O6)
		self.J4 = sim.send_hinge_joint(x=0, y=-c.L/2, z=c.L+c.R, n1=1, n2=0, n3=0, lo=-3.14159/2, hi=3.14159/2, first_body_id = self.O0, second_body_id = self.O3)
		self.J5 = sim.send_hinge_joint(x=0, y=-c.L*3/2, z=c.L+c.R, n1=1, n2=0, n3=0, lo=-3.14159/2, hi=3.14159/2, first_body_id = self.O3, second_body_id = self.O7)
		self.J6 = sim.send_hinge_joint(x=-c.L/2, y=0, z=c.L+c.R, n1=0, n2=-1, n3=0, lo=-3.14159/2, hi=3.14159/2, first_body_id = self.O0, second_body_id = self.O4)
		self.J7 = sim.send_hinge_joint(x=-c.L*3/2, y=0, z=c.L+c.R, n1=0, n2=-1, n3=0, lo=-3.14159/2, hi=3.14159/2, first_body_id = self.O4, second_body_id = self.O8)
